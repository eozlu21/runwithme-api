...
class RouteSimilarityController(
    ...
    fun getSimilarRoutesWithPreferences(
        ...
        try {
            val queryPrefs =
                preferenceService.validatePreferences(
            ...
            val combinedResults =
                similarRoutes
                    .mapNotNull { route ->
                        ...
                        val combinedScore =
                            preferenceService.calculateCombinedScore(
                                routeSimilarity,
                                prefMatches,
                                routeWeight,
                            )
    ...
    fun getSimilarForNewRouteWithPreferences(
        ...
        try {
            ...
            val similarRoutes =
                similarityService.findSimilarForNewRoute(
                    request.routeData,
                    topK * 2,
                )
